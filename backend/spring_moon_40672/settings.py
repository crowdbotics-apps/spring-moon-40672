"""
Django settings for spring_moon_40672 project.
...
ROOT_URLCONF = 'spring_moon_40672.urls'
...
WSGI_APPLICATION = 'spring_moon_40672.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_moon_40672 API",
    "DESCRIPTION": "API documentation for spring_moon_40672 App",
    "VERSION": "v1",
}
